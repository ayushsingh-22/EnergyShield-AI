"""Loads India import share and baseline demand data (Phase 1)."""
...
class ImportBaselineCollector(BaseCollector):
    def __init__(self):
        super().__init__(source_name="import_baseline")
    ...
    def fetch(self) -> List[RawSourceRecord]:
        try:
            seeded_data = [
                {
                    "title": "India Crude Import Baseline 2026",
                    "summary": "Baseline crude import requirements updated for India.",
                    "url": "https://example.com/baseline/india-crude",
                    "language": "en",
                    "location_name": "India",
