"""Collects or imports maritime advisory records (Phase 1, section 1.3)."""
...
class MaritimeAlertCollector(BaseCollector):
    def __init__(self):
        super().__init__(source_name="maritime_alerts")
    ...
    def fetch(self) -> List[RawSourceRecord]:
        try:
            seeded_data = [
                {
                    "title": "UKMTO Warning 001/2026",
                    "summary": "Suspicious approach reported in Bab el-Mandeb.",
                    "url": "https://example.com/alerts/ukmto-001",
                    "language": "en",
